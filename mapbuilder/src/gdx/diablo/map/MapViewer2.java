...
public class MapViewer2 extends ApplicationAdapter {
  ...
  public static void main(String[] args) {
    ...
    MapViewer2 client = new MapViewer2();
  ...
  public void create() {
    ...
    mapRenderer = new MapRenderer2(batch);
    mapRenderer.resize();
      ...
      public boolean keyDown(int keycode) {
        switch (keycode) {
          ...
          case Input.Keys.GRAVE:
            MapRenderer2.RENDER_DEBUG_WALKABLE++;
            if (MapRenderer2.RENDER_DEBUG_WALKABLE > Map.MAX_LAYERS + 1) {
              MapRenderer2.RENDER_DEBUG_WALKABLE = 0;
            }
            return true;
